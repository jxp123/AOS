...
def commit_page():
    ...
    repo=Repository(); payload=ui.textarea('Stage new pending change').classes('w-full')
    ...
    with ui.row():
        ui.button('Stage Note', on_click=stage); ui.button('Validate Queue', on_click=validate); ui.button('Commit Pending', on_click=commit)
