...
def export_ai_state():
    ...
    repo=Repository()
    state={'date':str(date.today()),'validation':validation_summary(),'apiary_entities':repo.list_apiary_entities(True),
           'queens':repo.list_queens(),'equipment':repo.list_equipment(),'genealogy':repo.list_genealogy(),
