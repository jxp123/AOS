...
from aos.ui import dashboard,colonies,queens,equipment,inspections,guided,natural_language,tasks,advisor,knowledge_graph,weather,validation,exports,system,inspection_scheduler
boot_aos()
@ui.page('/')
def index():
